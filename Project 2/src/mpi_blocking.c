...
int main(int argc, char** argv)
{
	...
	int numOfCoordinates,size,value,offset,processes,k,totalPoints,rank,length,chunk,offset2,sz,*tempLabels,len,prev,next,rec_value,tag1=1,tag2=2;
	char hostname[MPI_MAX_PROCESSOR_NAME];
	int store_value, flag=0;;
	...
	//Input data for each process. Uncomment to see the input data printed.
  ...
  //Each process prints its results. Uncomment to get results printed.
//	printf("\nThe distances calculated by process %d:\n",rank);
//	int counter=0;
//	for(int j=0; j<k*totalPoints/processes; j++)
//	{
//		printf("\nMin distance for point %d= %f from point %d",counter/k+rank*totalPoints/processes+1,finDistances[j],finLabels[j]+1); //+1 is used to have points start from 1 and above
//		counter++;																														//to be same with matlab's representation
//	}
//	printf("\n");
